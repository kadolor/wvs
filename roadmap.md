...
* The infrastructure, GitHub pages, is not suitable for production-level B2B software documentation.
...
* Wherobots UI Images were created in MS Paint and do not exist on the production site.
...
* Dimensional Data Depiction Engine (3DE) ™️ is a fictional technology that I created.
