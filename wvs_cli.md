...
Only paid Wherobots users can convert additional data points. To convert data that isn't included in the default `examples` directory, you must upgrade your account.
